...
% function  [Jc,para,dJ,H] = PALM_NCC_objFctn(T,Rc,z,omega,m,vRef,xc,omegaV,mV,N,vc,K,Kadj)
%
% Objective Function for LDDMM with source term using Lagrangian PDE solver
%
% computes J(vc) = D(K(T(yc(vc)+z)),Rc)  where
%
...
%  H       -  second dervivate of the regularizer S (Hessian)
%             with respect to vc
%==============================================================================
function [Jc,para,dJ,H] = PALM_NCC_objFctn(T,Rc,z,omega,m,vRef,xc,omegaV,mV,N,vc,K,Kadj)

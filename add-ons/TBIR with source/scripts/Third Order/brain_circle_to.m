% This script produces the results from Figure 2.
...
outputfolder = fullfile(FAIRpath, 'add-ons','TBIR with source', 'results','brain circle');
mkdir(outputfolder);
...
noise = 0.05; % Noise
alpha = [0.001,0.1, 1e-6]; % Regularization velocity.

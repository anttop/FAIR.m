%This script produces the results in Figure 4.
...
outputfolder = fullfile(FAIRpath, 'add-ons', 'TBIR with source', 'results','hands');
mkdir(outputfolder);
...
noise = 0.05; % Noise
alpha = [1,0.5, 1e-6]; % Regularization velocity.

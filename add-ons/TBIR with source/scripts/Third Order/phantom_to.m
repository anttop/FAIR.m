% This script produces the results from Figure 2.e) (proposed method).
...
outputfolder = fullfile(FAIRpath, 'add-ons', 'TBIR with source', 'results','phantom (proposed method)');
mkdir(outputfolder);
...
lambda = 0.1; % Regularization source
dist = 'SSD_op';
reg = 'mfThirdOrderST';
objfun = 'PALMobjFctn';

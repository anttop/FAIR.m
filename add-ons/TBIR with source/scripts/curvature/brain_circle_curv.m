% This script solves the proposed problem with curvature regularisation for
% v.
...
outputfolder = fullfile(FAIRpath, 'add-ons','TBIR with source', 'results','curvature','brain circle');
mkdir(outputfolder);
